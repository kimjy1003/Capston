...
def parse_args():
    ...
    ### -------  dataset settings --------------
    parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'ETTh2', 'ETTm1', 'ECL','BTCh1'], help='name of dataset')
    ...
    parser.add_argument('--save', action='store_true', help='save the output results')
...
def main():
    ...
    data_parser = {
        ...
        'BTCh1': {'data': 'BTC_1hour_data.csv', 'T': 'OT', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    }
    ...
    if args.evaluate:
        setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_inv{}_itr0_ours{}_seed{}'.format(args.model,args.data, args.features, args.seq_len, args.label_len, args.pred_len,args.lr,args.batch_size,args.hidden_size,args.stacks, args.levels,args.dropout,args.inverse,args.ours, args.seed)
        ...
        if args.itr:
            for ii in range(args.itr):
                ...
                setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_inv{}_itr{}_ours{}_seed{}'.format(args.model,args.data, args.features, args.seq_len, args.label_len, args.pred_len,args.lr,args.batch_size,args.hidden_size,args.stacks, args.levels,args.dropout,args.inverse,ii, args.ours, args.seed)
